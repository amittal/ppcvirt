...
9	&	pipe 	&	Passes a word from process A to process B and back to A	and measures round-trip time &	0.014	&	0.164	&	0.032	&	0.034&4.8x	\\	\hline
...
Our benchmarks are described in Table~\ref{tab:detailed_results}. We use four macrobenchmarks, namely Linux boot, Echo spawn,
...
\caption{Sources of VM exits, while comparing {\tt Static-TLB} with {\tt Adapt-PR}. We disable {\tt Adapt-DM} optimization for this experiment.}
\end{table*} 
