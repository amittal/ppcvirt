...
We require 75 LOC changes in a Linux guest to implement this mechanism. This is
significantly less than the 1100 LOC required by the Linux paravirtual
extensions.
...
\begin{table*}
\centering
\caption{Performance comparison of Different Optimizations}
...
\begin{table*}
\centering
\caption{Performance of Adaptive Page Resizing Algorithm}
