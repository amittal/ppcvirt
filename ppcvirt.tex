...
\caption{Performance comparison}
     ...
     & \multicolumn{5}{c|}{ Running Time in $sec$}\\  
      ...
      3& Find	& 0.39	& 1.89	& 0.71	& 0.67 \\ \hline
	   & \multicolumn{5}{c|}{Latency in $msec$}\\  \hline
...
next section, this page must be within 32MB of the
guest kernel's code section, for some translations to be possible.
Given that most guest kernel code sections are
small (e.g., XXX MB for Linux), this constraint is not particularly daunting.
...
Other opcodes require emulations which involve multiple instructions.
