...
a statically configured TLB ({\tt Static-TLB}). The static TLB configuration was setup such that it provides the best performance for the Linux boot benchmark. {\tt Adapt-DM} optimization is disabled for this experiment.}
\end{table*} 
...
\caption{Sources of VM exits, while comparing {\tt Static-TLB} with {\tt Adapt-PR}. {\tt Adapt-DM} optimization is disabled for this experiment.}
\end{table*} 
